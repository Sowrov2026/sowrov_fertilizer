...
const CROPS_V21 = [
    ...
    },
    {
        ...
        yieldPerAcre: '8-12 মণ',
        growthDuration: '110-130 দিন',
        fertilizer: {
                  "nitrogen": "60-80 কেজি/একর",
                  "phosphorus": "25-30 কেজি/একর",
                  "potassium": "20-30 কেজি/একর",
                  "organic": "800-1000 কেজি গোবর"
        },
        fertilizerSchedule: [
        ...
        plantingGuide: {
                  ...
                  "seedTreatment": "কারবোক্সিন ২ গ্রাম/কেজি বীজ",
                  "spacing": "২০-২৫ সেমি লাইন দূরত্ব",
                  "waterManagement": "২-৩ বার সেচ প্রয়োজন"
        },
        commonDiseases: [
            'ইয়ো রাস্ট (Puccinia striiformis)',
            'স্ক্যাব (Fusarium culmorum)',
            'লিফ ব্লোচ',
            'পাওয়ডারি মিলডিউ (Blumeria graminis)',
            'কার্ন বান্ট (Tilletia caries)',
            'লোজ স্মাট (Ustilago tritici)'
        ],
        commonPests: [
            'অ্যাফিড (Sitobion avenae)',
            'আর্মিওয়ার্ম',
            'স্টেম বোরার',
            'তেলা পোকা (Leaf miner)',
            'হেলিকোভারপা'
        ],
        organicMethods: [
            'নিম তেল ৫ মিলি/লিটার স্প্রে',
            'গোবর জীবাণুমুক্ত করে ব্যবহার',
            'সালফার স্প্রে (২.৫ গ্রাম/লিটার)',
            'পঞ্চগব্য ১০ লিটার/একর স্প্রে'
        ],
        chemicalSolutions: [
            'প্রোপিকোনাজল - রাস্ট রোগের জন্য',
            'কারবোক্সিন - স্ক্যাব রোগের জন্য',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'ম্যানকোজেব - ছত্রাক রোগের জন্য',
            'সাইপারমেথরিন - পোকা নিয়ন্ত্রণে'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন (BARI, Kanchon)',
            'বীজ শোধন অবশ্যই করুন',
    ...
    },
    {
        ...
        soilType: ["দোমাটি","বালুকামাটি","পলি"],
        waterRequirement: 'মাঝারি',
        temperature: {"min":15,"max":35,"optimal":25},
        plantingTime: 'নভেম্বর-ডিসেম্বর, ফেব্রুয়ারি-মার্চ',
        harvestTime: 'মার্চ-এপ্রিল, জুন-জুলাই',
        yieldPerAcre: '15-20 মণ',
        growthDuration: '90-120 দিন',
        fertilizer: {
                  "nitrogen": "70-90 কেজি/একর",
                  "phosphorus": "30-40 কেজি/একর",
                  "potassium": "30-40 কেজি/একর",
                  "organic": "1000-1200 কেজি গোবর"
        },
        fertilizerSchedule: [
        ...
        plantingGuide: {
                  ...
                  "seedTreatment": "থায়রাম ৩ গ্রাম/কেজি বীজ",
                  "spacing": "৭৫x২৫ সেমি দূরত্ব",
                  "waterManagement": "সেচ প্রয়োজন, বিশেষত ফুল ফোটার সময়"
        },
        commonDiseases: [
            'তুলা রোগ (Ustilago maydis)',
            'পাতার দাগ (Exserohilum turcicum)',
            'স্টেম রট (Fusarium)',
            'ডাউনি মিলডিউ (Peronosclerospora)',
            'ব্যাকটেরিয়াল উইল্ট',
            'মাইকোস্ফেরেলা লিফ ব্লাচ'
        ],
        commonPests: [
            'স্টেম বোরার (Chilo partellus)',
            'কর্ন বোরার (Helicoverpa)',
            'অ্যাফিড',
            'থ্রিপস',
            'আর্মি ওয়ার্ম',
            'কাটওয়ার্ম'
        ...
        organicMethods: [
            ...
            'গোবর জীবাণুমুক্ত করে ব্যবহার',
            'নিম পাতার অর্ক ১০ লিটার/একর',
            'ট্রাইকোডার্মা ২.৫ কেজি/একর মাটিতে মেশান'
        ],
        chemicalSolutions: [
            'ম্যানকোজেব - তুলা রোগের জন্য',
            'কারবোরান্ডান - স্টেম বোরার নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - ছত্রাক রোগের জন্য',
            'সাইপারমেথরিন - পোকা নিয়ন্ত্রণে'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন (BARI ভুট্টা-৪)',
            'বীজ শোধন অবশ্যই করুন',
            'মাটি ভালোভাবে প্রস্তুত করুন',
            'নিয়মিত সেচ দিন'
        ],
    ...
    },
    {
        ...
        harvestTime: 'মার্চ-এপ্রিল',
        yieldPerAcre: '5-8 মণ',
        growthDuration: '100-120 দিন',
        fertilizer: {
                  "nitrogen": "20-25 কেজি/একর",
                  "phosphorus": "40-50 কেজি/একর",
                  "potassium": "15-20 কেজি/একর",
                  "organic": "800-1000 কেজি গোবর"
        },
        fertilizerSchedule: [
        ...
        plantingGuide: {
                  ...
                  "seedTreatment": "কারবোক্সিন ২ গ্রাম/কেজি বীজ",
                  "spacing": "৩০x৫ সেমি দূরত্ব",
                  "waterManagement": "সেচ প্রয়োজন নেই, তবে চরম খরায় সেচ দিতে হবে"
        },
        commonDiseases: [
            'উঁচু গোড়া পচা (Fusarium oxysporum)',
            'পাতার দাগ (Alternaria)',
            'বীজ মরা',
            'রাইজোকটোনিয়া - গোড়া পচা',
            'স্ক্লেরোটিনিয়া স্টেম রট'
        ],
        commonPests: [
            'অ্যাফিড (Aphis craccivora)',
            'পোড় মাছি (Melanagromyza)',
            'বুট বোরার',
            'থ্রিপস',
            'লিফ মাইনার'
        ],
        organicMethods: [
            'নিম তেল স্প্রে ৫ মিলি/লিটার',
            'গোবর জীবাণুমুক্ত করে ব্যবহার',
            'বীজ শোধন ট্রাইসাইক্লাজল দিয়ে',
            'পঞ্চগব্য ১০ লিটার/একর স্প্রে'
        ],
        chemicalSolutions: [
            'কারবোক্সিন - বীজ মরা প্রতিরোধে',
            'ম্যানকোজেব - পাতার দাগ নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - গোড়া পচা নিয়ন্ত্রণে',
            'সাইপারমেথরিন - পোকা নিয়ন্ত্রণে'
        ],
        tips: [
    ...
    },
    {
        ...
        plantingTime: 'নভেম্বর-ডিসেম্বর',
        harvestTime: 'মার্চ-এপ্রিল',
        yieldPerAcre: '6-10 মণ',
        growthDuration: '100-120 দিন',
        fertilizer: {
                  "nitrogen": "15-20 কেজি/একর",
                  "phosphorus": "40-50 কেজি/একর",
                  "potassium": "20-25 কেজি/একর",
                  "organic": "800-1000 কেজি গোবর"
        },
        fertilizerSchedule: [
            { stage: 'বীজ বপনের সময়', fertilizer: 'ডিএপি', amount: '১০০-১৫০ কেজি/একর' },
        ...
        plantingGuide: {
                  "seedRate": "২০-২৫ কেজি/একর",
                  "seedTreatment": "কারবোক্সিন ২ গ্রাম/কেজি বীজ",
                  "spacing": "৩০x১০ সেমি দূরত্ব",
                  "waterManagement": "সেচ প্রয়োজন নেই"
        },
        commonDiseases: [
            'উঁচু গোড়া পচা (Fusarium oxysporum f. sp. ciceri)',
            'পাতার দাগ (Ascochyta rabiei)',
            'স্ক্যাব',
            'বোতাম পচা',
            'হেলিকোভারপা উইল্ট'
        ],
        commonPests: [
            'অ্যাফিড (Aphis craccivora)',
            'পোড় মাছি (Melanagromyza ciceri)',
            'বুট বোরার (Helicoverpa armigera)',
            'থ্রিপস',
            'কাটওয়ার্ম'
        ],
        organicMethods: [
            'নিম তেল স্প্রে ৫ মিলি/লিটার',
            'গোবর জীবাণুমুক্ত করে ব্যবহার',
            'বীজ শোধন কারবোক্সিন দিয়ে',
            'পঞ্চগব্য ১০ লিটার/একর স্প্রে'
        ],
        chemicalSolutions: [
            'কারবোক্সিন - বীজ মরা প্রতিরোধে',
            'ম্যানকোজেব - পাতার দাগ নিয়ন্ত্রণে',
            'সালফার - স্ক্যাব নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - গোড়া পচা নিয়ন্ত্রণে'
        ],
        tips: [
    ...
    },
    {
        ...
        commonDiseases: [
            'পাতার দাগ (Cercospora canescens)',
            'উঁচু গোড়া পচা (Fusarium oxysporum)',
            'ভাইরাস মোজাইক',
            'অ্যানথ্রাকনোজ',
            'সাদা মরা রোগ'
        ...
        commonPests: [
            'অ্যাফিড (Aphis gossypii)',
            'পোড় মাছি (Melanagromyza sojae)',
            'বুট বোরার (Helicoverpa armigera)',
            'থ্রিপস',
            'লিফ ফোল্ডার'
        ],
    ...
    },
    {
        ...
        commonDiseases: [
            'পাতার দাগ (Cercospora)',
            'উঁচু গোড়া পচা (Fusarium)',
            'ভাইরাস মোজাইক',
            'অ্যানথ্রাকনোজ',
            'বোতাম পচা'
        ],
    ...
    },
    {
        ...
        yieldPerAcre: '4-6 মণ',
        growthDuration: '90-110 দিন',
        fertilizer: {
                  "nitrogen": "40-50 কেজি/একর",
                  "phosphorus": "25-30 কেজি/একর",
                  "potassium": "15-20 কেজি/একর",
                  "organic": "800-1000 কেজি গোবর"
        },
        ...
        plantingGuide: {
                  "seedRate": "৫-৮ কেজি/একর",
                  "seedTreatment": "কারবোক্সিন ২ গ্রাম/কেজি বীজ",
                  "spacing": "৩০x১০ সেমি দূরত্ব",
                  "waterManagement": "সেচ প্রয়োজন নেই, তবে চরম খরায় সেচ দিতে হবে"
        },
        commonDiseases: [
            'অ্যাল্টারনেরিয়া ব্লাচ',
            'সুই প্রোগ (Albugo candida)',
            'হাইড্রোজেন সালফাইড টক্সিসিটি',
            'স্ক্লেরোটিনিয়া স্টেম রট',
            'ডাউনি মিলডিউ'
        ],
        commonPests: [
            'সরিষা মাছি (Plutella xylostella)',
            'অ্যাফিড (Brevicoryne brassicae)',
            'গলব্ল্যাডার',
            'স্ক্লেরোটিনিয়া',
            'লিফ মাইনার'
        ],
        ...
        chemicalSolutions: [
            'কারবোনডাজিম - ব্লাচ রোগ নিয়ন্ত্রণে',
            'সালফার - স্ক্লেরোটিনিয়া নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'ম্যানকোজেব - ছত্রাক রোগের জন্য',
            'সাইপারমেথরিন - পোকা নিয়ন্ত্রণে'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন (BARI সরিষা-১)',
            'বীজ শোধন অবশ্যই করুন',
            'মাটি ভালোভাবে প্রস্তুত করুন',
            'নিয়মিত আগাছা নিয়ন্ত্রণ করুন'
        ],
    ...
    },
    {
        ...
        soilType: ["বালুকামাটি","দোমাটি"],
        waterRequirement: 'মাঝারি',
        temperature: {"min":10,"max":25,"optimal":20},
        plantingTime: 'নভেম্বর-ডিসেম্বর',
        harvestTime: 'ফেব্রুয়ারি-মার্চ',
        yieldPerAcre: '80-120 মণ',
        growthDuration: '80-100 দিন',
        fertilizer: {
                  "nitrogen": "80-100 কেজি/একর",
                  "phosphorus": "60-80 কেজি/একর",
                  "potassium": "80-100 কেজি/একর",
                  "organic": "1500-2000 কেজি গোবর"
        },
        fertilizerSchedule: [
        ...
        plantingGuide: {
                  "seedRate": "৮০০-১০০০ কেজি/একর (গুঁটি)",
                  "seedTreatment": "ম্যানকোজেব ২.৫ গ্রাম/লিটার",
                  "spacing": "৬০x২০ সেমি দূরত্ব",
                  "waterManagement": "৩-৪ বার সেচ প্রয়োজন"
        },
        commonDiseases: [
            'লেট ব্লাইট (Phytophthora infestans)',
            'আরলি ব্লাইট (Alternaria solani)',
            'স্ক্যাব (Streptomyces scabies)',
            'ভাইরাস রোগ',
            'রাইজোকটোনিয়া',
            'ইরিনিয়া উইল্ট'
        ],
        commonPests: [
            'কলরাব মাছি (Phthorimaea operculella)',
            'অ্যাফিড',
            'থ্রিপস',
            'নেমাটোড',
            'কাটওয়ার্ম',
        ...
        organicMethods: [
            'নিম তেল স্প্রে ৫ মিলি/লিটার',
            'গোবর জীবাণুমুক্ত করে ব্যবহার',
            'বীজ শোধন ম্যানকোজেব দিয়ে',
            'মালচিং করে পানি রাখুন',
            'ট্রাইকোডার্মা ২.৫ কেজি/একর মাটিতে মেশান'
        ],
        chemicalSolutions: [
            'মেটালাক্সিল + ম্যানকোজেব - লেট ব্লাইট নিয়ন্ত্রণে',
            'ক্লোরোথালোনিল - আরলি ব্লাইট নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'ম্যানকোজেব - স্ক্যাব নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - ছত্রাক রোগের জন্য'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন (BARI আলু-১, আলু-২)',
            'বীজ শোধন অবশ্যই করুন',
            'মাটি ভালোভাবে প্রস্তুত করুন',
            'নিয়মিত সেচ দিন'
        ],
    ...
    },
    {
        ...
        fertilizer: {
                  "nitrogen": "60-80 কেজি/একর",
                  "phosphorus": "40-50 কেজি/একর",
                  "potassium": "40-50 কেজি/একর",
                  "organic": "1000-1500 কেজি গোবর"
        },
        fertilizerSchedule: [
            { stage: 'মাটি প্রস্তুতির সময়', fertilizer: 'গোবর/কমপোস্ট', amount: '১০-১৫ টন/একর' },
        ...
        plantingGuide: {
                  "seedRate": "৮-১০ কেজি/একর (বীজ)",
                  "seedTreatment": "ম্যানকোজেব ২.৫ গ্রাম/লিটার",
                  "spacing": "১৫x৫ সেমি দূরত্ব",
                  "waterManagement": "৩-৪ বার সেচ প্রয়োজন"
        },
        commonDiseases: [
            'ডাউনি মিলডিউ (Peronospora destructor)',
            'পাতার দাগ (Alternaria)',
            'বোতাম পচা (Erwinia)',
            'স্ক্লেরোটিনিয়া বোতাম পচা',
            'ব্লাইট (Phytophthora)'
        ],
        commonPests: [
            'পেঁয়াজ মাছি (Plutella xylostella)',
            'অ্যাফিড (Myzus persicae)',
            'থ্রিপস',
            'লিফ মাইনার',
            'স্টেম বোরার'
        ],
        ...
        chemicalSolutions: [
            'ম্যানকোজেব - পাতার দাগ নিয়ন্ত্রণে',
            'মেটালাক্সিল - ডাউনি মিলডিউ নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - ছত্রাক রোগের জন্য',
            'সাইপারমেথরিন - পোকা নিয়ন্ত্রণে'
        ],
    ...
    },
    {
        ...
        harvestTime: 'মার্চ-এপ্রিল',
        yieldPerAcre: '40-60 মণ',
        growthDuration: '120-140 দিন',
        fertilizer: {
                  "nitrogen": "50-60 কেজি/একর",
                  "phosphorus": "40-50 কেজি/একর",
                  "potassium": "30-40 কেজি/একর",
                  "organic": "1000-1500 কেজি গোবর"
        },
    ...
    },
    {
        ...
        plantingGuide: {
                  "seedRate": "৫০-১০০ গ্রাম/একর (বীজ)",
                  "seedTreatment": "ট্রাইসাইক্লাজল ২ গ্রাম/কেজি বীজ",
                  "spacing": "৬০x৪৫ সেমি দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
            'লেট ব্লাইট (Phytophthora infestans)',
            'আরলি ব্লাইট (Alternaria solani)',
            'ভার্টিসিলিয়াম উইল্ট (Verticillium dahliae)',
            'টমেটো মোজাইক ভাইরাস',
            'ব্যাকটেরিয়াল স্পট',
            'অ্যানথ্রাকনোজ'
        ],
        commonPests: [
            'হোয়াইটফ্লাই (Bemisia tabaci)',
            'অ্যাফিড (Myzus persicae)',
            'টুটি ফ্রুটি (Tuta absoluta)',
            'স্টেম বোরার (Helicoverpa armigera)',
            'লিফ মাইনার',
            'থ্রিপস'
        ],
        organicMethods: [
            ...
            'মালচিং করে পানি রাখুন',
            'ট্রাইকোডার্মা ২.৫ কেজি/একর মাটিতে মেশান',
            'স্টিকি ট্র্যাপ ব্যবহার করুন'
        ],
        chemicalSolutions: [
            'মেটালাক্সিল + ম্যানকোজেব - লেট ব্লাইট নিয়ন্ত্রণে',
            'ক্লোরোথালোনিল - আরলি ব্লাইট নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - হোয়াইটফ্লাই নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - ছত্রাক রোগের জন্য'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন (BARI টমেটো-১, টমেটো-২)',
            'বীজ শোধন অবশ্যই করুন',
            'মাটি ভালোভাবে প্রস্তুত করুন',
            'নিয়মিত সেচ দিন'
        ],
    ...
    },
    {
        ...
        commonDiseases: [
            'অ্যানথ্রাকনোজ (Colletotrichum)',
            'ডাউনি মিলডিউ (Peronospora)',
            'ভার্টিসিলিয়াম উইল্ট (Verticillium dahliae)',
            'ভাইরাস রোগ',
            'ব্যাকটেরিয়াল স্পট',
            'স্ক্লেরোটিনিয়া'
        ...
        commonPests: [
            'থ্রিপস (Thrips tabaci)',
            'অ্যাফিড (Myzus persicae)',
            'হোয়াইটফ্লাই (Bemisia tabaci)',
            'ফুল বোরার (Helicoverpa armigera)',
            'লিফ মাইনার',
            'কাটওয়ার্ম'
        ],
        organicMethods: [
        ...
        chemicalSolutions: [
            'ম্যানকোজেব - অ্যানথ্রাকনোজ নিয়ন্ত্রণে',
            'মেটালাক্সিল - ডাউনি মিলডিউ নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - থ্রিপস নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - ছত্রাক রোগের জন্য'
        ],
        tips: [
    ...
    },
    {
        ...
        plantingTime: 'অক্টোবর-নভেম্বর, ফেব্রুয়ারি-মার্চ',
        harvestTime: 'জানুয়ারি-মার্চ, মে-জুন',
        yieldPerAcre: '60-100 মণ',
        growthDuration: '90-120 দিন',
        fertilizer: {
                  "nitrogen": "80-100 কেজি/একর",
                  "phosphorus": "50-60 কেজি/একর",
                  "potassium": "50-60 কেজি/একর",
                  "organic": "1500-2000 কেজি গোবর"
        },
        fertilizerSchedule: [
            { stage: 'রোপণের সময়', fertilizer: 'গোবর/কমপোস্ট', amount: '১০-১৫ টন/একর' },
        ...
        commonDiseases: [
            'ফসারিয়াম উইল্ট (Fusarium oxysporum)',
            'লিটল লিফ (Phytolasta)',
            'ভার্টিসিলিয়াম উইল্ট (Verticillium dahliae)',
            'অ্যানথ্রাকনোজ (Colletotrichum)',
            'ব্লাইট (Phytophthora)',
        ...
        commonPests: [
            'বোরার (Leucinodes orbonalis)',
            'অ্যাফিড (Myzus persicae)',
            'জাপানিজ বিটল (Brachia indica)',
            'থ্রিপস',
            'লিফ মাইনার',
            'হোয়াইটফ্লাই'
        ],
        ...
        chemicalSolutions: [
            'কার্বেন্ডাজিম - ফসারিয়াম উইল্ট নিয়ন্ত্রণে',
            'ম্যানকোজেব - অ্যানথ্রাকনোজ নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - অ্যাফিড নিয়ন্ত্রণে',
            'ডাইমিথোলেট - থ্রিপস নিয়ন্ত্রণে',
            'কার্বোরান্ডান - বোরার নিয়ন্ত্রণে'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন (BARI বেগুন-১, বেগুন-২)',
            'বীজ শোধন অবশ্যই করুন',
            'মাটি ভালোভাবে প্রস্তুত করুন',
            'নিয়মিত সেচ দিন'
        ],
    ...
    },
    {
        ...
        waterRequirement: 'মাঝারি',
        temperature: {"min":10,"max":25,"optimal":18},
        plantingTime: 'সেপ্টেম্বর-অক্টোবর',
        harvestTime: 'ডিসেম্বর-জানুয়ারি',
        yieldPerAcre: '60-100 মণ',
        growthDuration: '90-120 দিন',
        fertilizer: {
                  "nitrogen": "80-100 কেজি/একর",
        ...
        plantingGuide: {
                  "seedRate": "৫০-১০০ গ্রাম/একর (বীজ)",
                  "seedTreatment": "ট্রাইসাইক্লাজল ২ গ্রাম/কেজি বীজ",
                  "spacing": "৪৫x৪৫ সেমি দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
            'অ্যাল্টারনেরিয়া ব্লাচ (Alternaria brassicicola)',
            'ডাউনি মিলডিউ (Hyaloperonospora parasitica)',
        ...
        commonPests: [
            'ডায়মন্ডব্যাক মথ (Plutella xylostella)',
            'অ্যাফিড (Brevicoryne brassicae)',
            'কাটওয়ার্ম (Spodoptera litura)',
            'লিফ মাইনার',
            'থ্রিপস',
            'হোয়াইটফ্লাই'
        ],
        organicMethods: [
            'নিম তেল স্প্রে ৫ মিলি/লিটার',
            'গোবর জীবাণুমুক্ত করে ব্যবহার',
            'নেট ব্যবহার করুন (৪০ মেশ)',
            'ট্রাইকোডার্মা ২.৫ কেজি/একর মাটিতে মেশান',
            'স্টিকি ট্র্যাপ ব্যবহার করুন'
        ],
        chemicalSolutions: [
            'ম্যানকোজেব - ব্লাচ রোগ নিয়ন্ত্রণে',
            'মেটালাক্সিল - ডাউনি মিলডিউ নিয়ন্ত্রণে',
            'সাইপারমেথরিন - ডায়মন্ডব্যাক মথ নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - ছত্রাক রোগের জন্য'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন (BARI ফুলকপি-১)',
            'বীজ শোধন অবশ্যই করুন',
            'মাটি ভালোভাবে প্রস্তুত করুন',
            'নিয়মিত সেচ দিন'
        ],
    ...
    },
    {
        ...
        season: ["শীত","গ্রীষ্ম"],
        districts: ["ঢাকা","কুমিল্লা","ময়মনসিংহ","রাজশাহী","বরিশাল"],
        soilType: ["দোমাটি","দোআশ","পলি"],
        waterRequirement: 'মাঝারি',
        temperature: {"min":15,"max":30,"optimal":22},
        plantingTime: 'সারা বছর',
        harvestTime: '২০-৩০ দিন পর',
        yieldPerAcre: '200-400 কেজি',
        growthDuration: '20-40 দিন',
        fertilizer: {
                  "nitrogen": "40-50 কেজি/একর",
                  "phosphorus": "20-30 কেজি/একর",
                  "potassium": "20-30 কেজি/একর",
                  "organic": "1000-1500 কেজি গোবর"
        },
        fertilizerSchedule: [
        ...
        plantingGuide: {
                  "seedRate": "৫-১০ কেজি/একর (বীজ)",
                  "seedTreatment": "ট্রাইসাইক্লাজল ২ গ্রাম/কেজি বীজ",
                  "spacing": "১০-১৫ সেমি দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
            'পাতার দাগ (Alternaria/Cercospora)',
            'ডাউনি মিলডিউ',
            'সাদা মাখি',
            'ব্লাইট',
            'ভাইরাস রোগ'
        ...
        chemicalSolutions: [
            ...
            'মেটালাক্সিল - ডাউনি মিলডিউ নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - অ্যাফিড নিয়ন্ত্রণে',
            'ডাইমিথোলেট - কাটওয়ার্ম নিয়ন্ত্রণে',
            'সাইপারমেথরিন - পোকা নিয়ন্ত্রণে'
        ],
        tips: [
            'তাজা শাকসবজি খান',
    ...
    },
    {
        ...
        season: ["গ্রীষ্ম","বর্ষাকাল"],
        districts: ["ঢাকা","কুমিল্লা","ময়মনসিংহ","রাজশাহী","বরিশাল","খুলনা","চট্টগ্রাম"],
        soilType: ["দোআশ","দোমাটি","পলি"],
        waterRequirement: 'উচ্চ',
        temperature: {"min":15,"max":38,"optimal":27},
        plantingTime: 'সেপ্টেম্বর-নভেম্বর',
        harvestTime: '১০-১২ মাস পর',
        yieldPerAcre: '15-25 মণ',
        growthDuration: '300-365 দিন',
        fertilizer: {
                  "nitrogen": "80-100 কেজি/একর",
                  "phosphorus": "40-50 কেজি/একর",
                  "potassium": "100-120 কেজি/একর",
                  "organic": "1500-2000 কেজি গোবর"
        },
        fertilizerSchedule: [
        ...
        plantingGuide: {
                  "seedRate": "২x২ মিটার দূরত্বে রোপণ",
                  "seedTreatment": "কলম শোধন কার্বেন্ডাজিম দিয়ে",
                  "spacing": "২x২ মিটার দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
            'পানামা রোগ (Fusarium oxysporum f. sp. cubense)',
            'সিগাটোকা (Mycosphaerella fijiensis)',
            'ব্ল্যাক সিগাটোকা',
            'ব্যাকটেরিয়াল ওয়িল্ট (Ralstonia solanacearum)',
            'ফোকাল স্পট',
            'এরোসিওন নেক্রোটিক স্পট'
        ],
        commonPests: [
            'ব্যানানা সাপ (Ophiophagus hannah)',
            'থ্রিপস (Thrips)',
            'অ্যাফিড',
            'মিট',
            'করোরা'
        ...
        chemicalSolutions: [
            'কার্বেন্ডাজিম - পানামা রোগ নিয়ন্ত্রণে',
            'কপার অক্সিক্লোরাইড ৩ গ্রাম/লিটার - সিগাটোকা নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - থ্রিপস নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'ম্যানকোজেব - ছত্রাক রোগের জন্য'
        ],
    ...
    },
    {
        ...
        harvestTime: 'মে-জুন',
        yieldPerAcre: '100-200 মণ (পাকা আম)',
        growthDuration: 'বীজ থেকে ৫-৭ বছর, কলম ৩-৪ বছর',
        fertilizer: {
                  "nitrogen": "60-80 কেজি/একর",
                  "phosphorus": "30-40 কেজি/একর",
                  "potassium": "60-80 কেজি/একর",
                  "organic": "2000-3000 কেজি গোবর"
        },
        fertilizerSchedule: [
        ...
        plantingGuide: {
                  "seedRate": "১০x১০ মিটার দূরত্বে রোপণ",
                  "seedTreatment": "কলম শোধন কার্বেন্ডাজিম দিয়ে",
                  "spacing": "১০x১০ মিটার দূরত্ব",
                  "waterManagement": "বিশেষত ফুল ফোটার সময় সেচ প্রয়োজন"
        },
        commonDiseases: [
            'অ্যানথ্রাকনোজ (Colletotrichum gloeosporioides)',
            'পাউডারি মিলডিউ (Oidium mangiferae)',
            'গামোসেলা (Bacterial canker)',
            'সুই ড্যাম্পিং অফ',
            'মালসিও কোট রট',
            'সোয়ার্ট ক্যান্কার'
        ],
        commonPests: [
            'স্টেম বোরার (Indarbela tetraonis)',
            'মাংকিপক্স',
            'গলব্ল্যাডার',
            'মিলিবাগ',
            'মিচ',
        ...
        organicMethods: [
            'নিম তেল স্প্রে ৫ মিলি/লিটার',
            'গোবর জীবাণুমুক্ত করে ব্যবহার',
            'কপার সালফেট স্প্রে (২ গ্রাম/লিটার)',
            'পোলার্ড স্প্রে (২০ গ্রাম/লিটার)',
            'আক্রান্ত ফল তুলে ফেলুন'
        ],
        chemicalSolutions: [
            'কার্বেন্ডাজিম - অ্যানথ্রাকনোজ নিয়ন্ত্রণে',
            'সালফার ২.৫ গ্রাম/লিটার - পাউডারি মিলডিউ নিয়ন্ত্রণে',
            'ডাইমিথোলেট - মিলিবাগ নিয়ন্ত্রণে',
            'ম্যানকোজেব - ছত্রাক রোগের জন্য',
            'কার্বোরান্ডান - স্টেম বোরার নিয়ন্ত্রণে'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন (Langra, Dasheri, Fazli)',
            'কলম শোধন অবশ্যই করুন',
            'নিয়মিত সেচ দিন',
            'আক্রান্ত ফল তুলে ফেলুন'
        ],
    ...
    },
    {
        ...
        plantingGuide: {
                  "seedRate": "৮x৮ মিটার দূরত্বে রোপণ",
                  "seedTreatment": "কলম শোধন কার্বেন্ডাজিম দিয়ে",
                  "spacing": "৮x৮ মিটার দূরত্ব",
                  "waterManagement": "বিশেষত ফুল ফোটার সময় সেচ প্রয়োজন"
        },
        commonDiseases: [
            'অ্যানথ্রাকনোজ (Colletotrichum)',
            'পাউডারি মিলডিউ (Oidium)',
            'কালো বুঝি (Litchi chinensis)',
            'মালসিও কোট রট',
            'সুই ড্যাম্পিং অফ'
        ],
        commonPests: [
    ...
    },
    {
        ...
        waterRequirement: 'মাঝারি',
        temperature: {"min":20,"max":35,"optimal":28},
        plantingTime: 'জুন-জুলাই, ফেব্রুয়ারি-মার্চ',
        harvestTime: '৮-১২ মাস পর',
        yieldPerAcre: '40-80 মণ',
        growthDuration: '240-365 দিন',
        fertilizer: {
                  "nitrogen": "60-80 কেজি/একর",
                  "phosphorus": "40-50 কেজি/একর",
                  "potassium": "60-80 কেজি/একর",
        ...
        plantingGuide: {
                  "seedRate": "৩x২ মিটার দূরত্বে রোপণ",
                  "seedTreatment": "বীজ শোধন ট্রাইসাইক্লাজল দিয়ে",
                  "spacing": "৩x২ মিটার দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
            'পাপায়া রিং স্পট ভাইরাস',
            'অ্যানথ্রাকনোজ (Colletotrichum)',
            'ফসারিয়াম উইল্ট (Fusarium oxysporum)',
            'ব্ল্যাক রট (Phytophthora)',
        ...
        chemicalSolutions: [
            'কার্বেন্ডাজিম - অ্যানথ্রাকনোজ নিয়ন্ত্রণে',
            'ম্যানকোজেব - ফসারিয়াম উইল্ট নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - অ্যাফিড নিয়ন্ত্রণে',
            'ডাইমিথোলেট - থ্রিপস নিয়ন্ত্রণে',
            'কার্বোরান্ডান - ফল মথ নিয়ন্ত্রণে'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন',
            'বীজ শোধন অবশ্যই করুন',
    ...
    },
    {
        ...
        waterRequirement: 'মাঝারি',
        temperature: {"min":20,"max":35,"optimal":28},
        plantingTime: 'ফেব্রুয়ারি-মার্চ',
        harvestTime: 'মে-জুন',
        yieldPerAcre: '80-120 মণ',
        growthDuration: '80-100 দিন',
        fertilizer: {
        ...
        commonDiseases: [
            'অ্যানথ্রাকনোজ (Colletotrichum)',
            'ডাউনি মিলডিউ (Pseudoperonospora)',
            'ফসারিয়াম উইল্ট (Fusarium oxysporum)',
            'মসাইক ভাইরাস',
            'অ্যানথ্রাকনোজ'
        ],
    ...
    },
    {
        ...
        yieldPerAcre: '100-150 মণ',
        growthDuration: '60-80 দিন',
        fertilizer: {
                  "nitrogen": "60-80 কেজি/একর",
                  "phosphorus": "40-50 কেজি/একর",
                  "potassium": "40-50 কেজি/একর",
        ...
        chemicalSolutions: [
            'মেটালাক্সিল - ডাউনি মিলডিউ নিয়ন্ত্রণে',
            'সালফার - পাউডারি মিলডিউ নিয়ন্ত্রণে',
            'ম্যানকোজেব - অ্যানথ্রাকনোজ নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - অ্যাফিড নিয়ন্ত্রণে',
            'ডাইমিথোলেট - ফল মথ নিয়ন্ত্রণে'
        ],
    ...
    },
    {
        ...
        soilType: ["বালুকামাটি","পলি","দোমাটি"],
        waterRequirement: 'মাঝারি',
        temperature: {"min":20,"max":35,"optimal":27},
        plantingTime: 'জুন-সেপ্টেম্বর',
        harvestTime: 'সারা বছর',
        yieldPerAcre: '80-120টি নারিকেল',
        growthDuration: 'বীজ থেকে ৫-৬ বছর, ফল ধরতে ৫-৬ বছর',
        fertilizer: {
                  "nitrogen": "50-60 কেজি/একর",
                  "phosphorus": "30-40 কেজি/একর",
                  "potassium": "80-100 কেজি/একর",
        ...
        plantingGuide: {
                  "seedRate": "৮x৮ মিটার দূরত্বে রোপণ",
                  "seedTreatment": "বীজ শোধন কার্বেন্ডাজিম দিয়ে",
                  "spacing": "৮x৮ মিটার দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
        ...
        chemicalSolutions: [
            'কার্বেন্ডাজিম - বুলাগো রোগ নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - মিলিবাগ নিয়ন্ত্রণে',
            'ডাইমিথোলেট - ক্যাটারপিলার নিয়ন্ত্রণে',
            'ম্যানকোজেব - ছত্রাক রোগের জন্য',
            'কার্বোরান্ডান - ওয়িভিল নিয়ন্ত্রণে'
        ],
        tips: [
            'উন্নত জাত ব্যবহার করুন',
            'বীজ শোধন অবশ্যই করুন',
    ...
    },
    {
        ...
        yieldPerAcre: '200-300 কেজি',
        growthDuration: '৬-৮ মাস (চারা থেকে প্রথম ফলন)',
        fertilizer: {
                  "nitrogen": "40-50 কেজি/একর",
                  "phosphorus": "30-40 কেজি/একর",
                  "potassium": "40-50 কেজি/একর",
        ...
        plantingGuide: {
                  "seedRate": "৩x১.৫ মিটার দূরত্বে রোপণ",
                  "seedTreatment": "চারা শোধন কার্বেন্ডাজিম দিয়ে",
                  "spacing": "৩x১.৫ মিটার দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
            'পান পাতার দাগ',
        ...
        chemicalSolutions: [
            ...
            'কার্বেন্ডাজিম - অ্যানথ্রাকনোজ নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - অ্যাফিড নিয়ন্ত্রণে',
            'ডাইমিথোলেট - পোকা নিয়ন্ত্রণে',
            'সাইপারমেথরিন - পোকা নিয়ন্ত্রণে'
        ],
        tips: [
            'ছায়ার ব্যবস্থাপনা করুন',
            'নিয়মিত সেচ দিন',
    ...
    },
    {
        ...
        soilType: ["পলি","দোমাটি","বালুকামাটি"],
        waterRequirement: 'উচ্চ',
        temperature: {"min":10,"max":30,"optimal":22},
        plantingTime: 'জুন-সেপ্টেম্বর (চারা রোপণ)',
        harvestTime: 'মার্চ-ডিসেম্বর (নিয়মিত তোলা)',
        yieldPerAcre: '800-1200 কেজি (কাঁচা পাতা)',
        growthDuration: 'চারা থেকে ৩-৪ বছর, তোলা সারা বছর',
        fertilizer: {
                  "nitrogen": "60-80 কেজি/একর",
                  "phosphorus": "30-40 কেজি/একর",
                  "potassium": "40-50 কেজি/একর",
        ...
        plantingGuide: {
                  "seedRate": "১.৫x০.৮ মিটার দূরত্বে রোপণ",
                  "seedTreatment": "চারা শোধন কার্বেন্ডাজিম দিয়ে",
                  "spacing": "১.৫x০.৮ মিটার দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
            'ব্লাস্ট',
        ...
        chemicalSolutions: [
            'কার্বেন্ডাজিম - ক্যান্কার নিয়ন্ত্রণে',
            'ম্যানকোজেব - ব্লাস্ট নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - অ্যাফিড নিয়ন্ত্রণে',
            'ডাইমিথোলেট - পোকা নিয়ন্ত্রণে',
            'সাইপারমেথরিন - পোকা নিয়ন্ত্রণে'
        ],
    ...
    },
    {
        ...
        soilType: ["পলি","দোমাটি","দোআশ"],
        waterRequirement: 'উচ্চ',
        temperature: {"min":20,"max":38,"optimal":30},
        plantingTime: 'ফেব্রুয়ারি-মার্চ',
        harvestTime: 'ডিসেম্বর-মার্চ',
        yieldPerAcre: '250-400 মণ',
        growthDuration: '12-14 মাস',
        fertilizer: {
                  "nitrogen": "80-100 কেজি/একর",
                  "phosphorus": "40-50 কেজি/একর",
                  "potassium": "60-80 কেজি/একর",
        ...
        plantingGuide: {
                  "seedRate": "১০০০-১২০০ কেজি/একর (বীজ)",
                  "seedTreatment": "কার্বেন্ডাজিম দিয়ে শোধন",
                  "spacing": "৯০x৯০ সেমি দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
            'স্মাট রোग (Ustilago scitaminea)',
            'রেড রট (Acetobacter sacchari)',
            'ইয়েলো স্পট',
            'মলাসেসেস'
        ],
        commonPests: [
        ...
        chemicalSolutions: [
            'ট্রাইসাইক্লাজল - স্মাট রোগ নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - রেড রট নিয়ন্ত্রণে',
            'ইমিডাক্লোপ্রিড - অ্যাফিড নিয়ন্ত্রণে',
            'ডাইমিথোলেট - পোকা নিয়ন্ত্রণে',
            'ম্যানকোজেব - ছত্রাক রোগের জন্য'
        ],
    ...
    },
    {
        ...
        waterRequirement: 'উচ্চ',
        temperature: {"min":20,"max":35,"optimal":28},
        plantingTime: 'এপ্রিল-মে',
        harvestTime: 'জুলাই-আগস্ট',
        yieldPerAcre: '10-15 মণ (কাঁচা পাট)',
        growthDuration: '100-120 দিন',
        fertilizer: {
                  "nitrogen": "40-50 কেজি/একর",
                  "phosphorus": "20-30 কেজি/একর",
        ...
        commonDiseases: [
            'পাট ঝলসানো রোগ (Macrophomina phaseolina)',
            'অ্যানথ্রাকনোজ (Colletotrichum)',
            'পাতার দাগ (Alternaria)',
            'ব্লাইট (Phytophthora)'
        ],
    ...
    },
    {
        ...
        temperature: {"min":20,"max":35,"optimal":28},
        plantingTime: 'মে-জুন',
        harvestTime: 'সেপ্টেম্বর-অক্টোবর',
        yieldPerAcre: '6-10 মণ',
        growthDuration: '90-110 দিন',
        fertilizer: {
                  "nitrogen": "30-40 কেজি/একর",
                  "phosphorus": "20-25 কেজি/একর",
                  "potassium": "15-20 কেজি/একর",
                  "organic": "600-800 কেজি গোবর"
        },
        fertilizerSchedule: [
            { stage: 'রোপণের সময়', fertilizer: 'গোবর/কমপোস্ট', amount: '৫-৮ টন/একর' },
            { stage: '১৫-২০ দিন', fertilizer: 'ইউরিয়া', amount: '১৫-২০ কেজি/একর' },
        ...
        chemicalSolutions: [
            'ম্যানকোজেব - পাতার দাগ নিয়ন্ত্রণে',
            'কার্বেন্ডাজিম - গাছ পোড়া নিয়ন্ত্রণে',
            'ডাইমিথোলেট - অ্যাফিড নিয়ন্ত্রণে',
            'কার্বোরান্ডান - স্টেম বোরার নিয়ন্ত্রণে',
            'সাইপারমেথরিন - পোকা নিয়ন্ত্রণে'
        ],
    ...
    },
    {
        ...
        plantingGuide: {
                  "seedRate": "১০-১৫ কেজি/একর",
                  "seedTreatment": "কারবোক্সিন ২ গ্রাম/কেজি বীজ",
                  "spacing": "২০x১০ সেমি দূরত্ব",
                  "waterManagement": "নিয়মিত সেচ প্রয়োজন"
        },
        commonDiseases: [
            'পাতার দাগ (Alternaria)',
            'ডাউনি মিলডিউ (Plasmopara)',
            'অ্যাল্টারনেরিয়া ব্লাচ',
            'ব্লাইট'
        ],
        commonPests: [
