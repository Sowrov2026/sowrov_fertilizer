    ...
    try {
        ...
        switch (action) {
            ...
            default:
                ...
                res.end(JSON.stringify({ error: `Unknown action: ${action}. Available: predictDemand, predictDiseaseRisk, predictCropYield, assessWeatherRisk, predictBusinessGrowth, predictCropPrice` }));
                return;
        }
