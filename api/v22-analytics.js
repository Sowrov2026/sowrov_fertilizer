    ...
    try {
        ...
        switch (action) {
            ...
            case 'export':
                ...
                const exportHeaders = { ...corsHeaders, 'Content-Type': format === 'csv' ? 'text/csv' : 'application/json', 'Content-Disposition': `attachment; filename="analytics-${type}.${format}"` };
                res.writeHead(200, exportHeaders);
