...
const DISTRICTS = [
    ...
    'নারায়ণগঞ্জ', 'সিরাজগঞ্জ', 'পাবনা', 'নওগাঁ', 'চাঁপাইনবাবগঞ্জ', 'জয়পুরহাট', 'সিরাজগঞ্জ',
    'লালমনিরহাট', 'নীলফামারী', 'রংপুর', 'কুড়িগ্রাম', 'লালমনিরহাট', 'গাইবান্ধা', 'ঠাকুরগাঁও',
    'পঞ্চগড়', 'বান্দরবান', 'রাঙ্গামাটি', 'খাগড়াছড়ি', 'ফেনী', 'কুমিল্লা', 'ব্রাহ্মণবাড়িয়া',
    'চাঁদপুর', 'লক্ষ্মীপুর', 'নোয়াখালী', 'কক্সবাজার', 'রাঙ্গামাটি', 'বান্দরবান', 'খাগড়াছড়ি'
];

const CROPS = [
    'ধান', 'গম', 'ভুট্টা', 'পাট', 'তুলা', 'সরিষা', 'আলু', 'মিষ্টি আলু',
    'পেঁয়াজ', 'রসুন', 'মরিচ', 'বেগুন', 'টমেটো', 'শাকসবজি', 'পাকড়', 'ঢেঁড়স',
    'করলা', 'কুমড়া', 'লাউ', 'বেগুন', 'শিম', 'মটরশুটি', 'সয়াবিন', 'মুগ',
    'কলাই', 'চিনাবাদাম', 'সূর্যমুখী', 'আম', 'কাঁঠাল', 'পেপে', 'পেয়ারা',
    'জাম', 'তাল', 'নারিকেল', 'লেবু', 'কমলা', 'বাতাবি', 'ডুরিয়ান', 'জ্যাকফ্রুট',
    'ধনিয়া', 'জিরা', 'হলুদ', 'আদা', 'লঙ্কা', 'জলপাই', 'বাঁধাকপি', 'ফুলকপি',
    'পুঁই', 'কচু', 'কইল', 'পানির শাক', 'পুদিনা', 'ধুন্দুল', 'কাউ
', 'সেম',
    'মাস', 'বরকল', 'কালাবাইঞ্জি', 'রাতালু', 'নারকেল', 'তিল', 'পেস্ট'
];
...
export const SFMemory = {
    ...
    extractLocation(text) {
        ...
        const districtPatterns = [
            /(?:জেলা|district|জেলায়|জেলা\s*থেকে|জেলা\s*বাসি)\s*[:=]?\s*([\w\s]{3,30})/i,
            /([\w\s]{3,30})\s*(?:জেলা|district)/i,
        ];
        ...
        const upazilaPattern = /(?:উপজেলা|upazila|সাবডিভিশন)\s*[:=]?\s*([\w\s]{3,30})/i;
        ...
        const villagePattern = /(?:গ্রাম|village|মৌজা)\s*[:=]?\s*([\w\s]{3,40})/i;
    ...
    extractFarmSize(text) {
        const patterns = [
            ...
            /(\d+(?:\.\d+)?)\s*(?:শতক|shotok)/i,
            /(?:জমি|land|farm|খেত)\s*(?:আছে| ache|ase)?\s*(?:\d+(?:\.\d+)?)\s*([বিঘাacrehectareকানি])/i,
            /(?:আমার|আমি)\s*(\d+(?:\.\d+)?)\s*([বিঘাacrehectareকানি])/i,
        ];
