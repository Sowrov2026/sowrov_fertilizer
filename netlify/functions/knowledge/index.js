/**
 * Knowledge Base Index — V12 Agriculture Brain
...
const brinjal = require('./crops/brinjal');
const potato = require('./crops/potato');
const onion = require('./crops/onion');
const garlic = require('./crops/garlic');
const mango = require('./crops/mango');
const banana = require('./crops/banana');
const papaya = require('./crops/papaya');
const cucumber = require('./crops/cucumber');
const watermelon = require('./crops/watermelon');
const cabbage = require('./crops/cabbage');
const cauliflower = require('./crops/cauliflower');
const lau = require('./crops/lau');
const jackfruit = require('./crops/jackfruit');
...
const nutrient = require('./diseases/nutrient');
const pestDiseases = require('./diseases/pest');
const organic = require('./fertilizers/organic');
const chemical = require('./fertilizers/chemical');
const insects = require('./insects/insects');
const weeds = require('./weeds/weeds');
const pests = require('./pests/pests');
...
const faqDB = require('./faq/database');
